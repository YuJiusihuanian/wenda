...
//tab
const getTabInfoTab = (tab , isClass) => {
  let str = '';
  let className = '';
  if(tab){
    switch (tab) {
...
//top
const getTabInfoTop = (top ,isClass) =>{
  let str = '';
  let className = '';
  if(top){
    str = '顶';
...
//good
const getTabInfoGood = (good ,isClass) =>{
  let str = '';
  let className = '';
  if(good){
    str = '精';
...
export default{
  ...
  getTabInfoTab : getTabInfoTab,
  getTabInfoGood : getTabInfoGood,
  getTabInfoTop : getTabInfoTop
}
